  ...
  return (
    <Fragment>
      ...
      <div className="text-sm text-gray-600 mt-2">
          Total de Produtos Cadastrados {products && products.length}
        </div>
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              <th className="px-4 py-2 border">Produtos</th>
              <th className="px-4 py-2 border">Descrições</th>
              <th className="px-4 py-2 border">Imagens</th>
              ...
              <th className="px-4 py-2 border">Adicionado em</th>
              <th className="px-4 py-2 border">Ultima Atualização</th>
