  ...
  return (
    <Fragment>
      ...
      <div className="text-sm text-gray-600 mt-2">
          Total de Pedidos {orders && orders.length}
        </div>
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">ID do Pedido</th>
              <th className="px-4 py-2 border">Nome Cliente</th>
              <th className="px-4 py-2 border">Email</th>
              <th className="px-4 py-2 border">Celular</th>
              <th className="px-4 py-2 border">Enviado para</th>
              <th className="px-4 py-2 border">Pedido Feito em</th>
              <th className="px-4 py-2 border">Ultima Atualização em</th>
