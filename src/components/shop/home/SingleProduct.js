  ...
  return (
    <Fragment>
      {products && products.length > 0 ? (
        ...
        onClick={(e) =>
          (
            window.location.href = "https://api.whatsapp.com/send?phone=5515997790819&text=Ola%20equipe%20da%20Black%20Wolves%20Estou%20Entrando%20em%20Contato%20Por%20n%C3%A3o%20ter%20Encontrado%20o%20Produto%3A"
          )
        } 
        className="col-span-2 md:col-span-3 lg:col-span-4 flex items-center justify-center py-24 text-2xl">
        <center><h2>Sua busca não encontrou resultado algum :(</h2><br/>
        <p id='sujestao' >Desejo Pedir Por um Produto Não Listado!</p>
