  ...
  if (loading) {
    return (
      ...
      <div className="my-32 text-2xl text-center">
        <center>Sua Lista de Desejos está Vazia</center>
      </div>
    );
  }
  return (
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {products.length > 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  {product.pQuantity > 0 ? (
                    <div className="text-green-500 my-1 md:my-0">Disponivel</div>
                  ) : (
                    <div className="text-red-500 my-1 md:my-0">Sem Estoque</div>
                  )}
          ...
          <div>Lista de Desejos Vazia</div>
        )}
      </div>
    </Fragment>
  );
