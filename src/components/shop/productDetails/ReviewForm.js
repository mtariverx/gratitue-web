      ...
      {ratingUserList.includes(isAuthenticate().user._id) ? (
        ...
        <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
          <div className="flex flex-col space-y-2">
            <span className="text-2xl font-medium">Deixe sua Avaliação</span>
            <span className="text-gray-600 text-sm">
              Ajude a Mantermos A Black Wolves Apenas com os Produtos Melhores Avaliados*
            </span>
          </div>
          {/* Input Rating */}
          <div className="mb-4">
            ...
            >
              ...
              <label
                className="full"
                htmlFor="star5"
                title="Eu Recomendo Esse Produto a Todos"
              />
              <input
                type="radio"
                className="rating"
              ...
              <label
                className="full"
                htmlFor="star4"
                title="Muito Bom Acima das Minhas Expectativas"
              />
              <input
                type="radio"
                className="rating"
                ...
                defaultValue={3}
              />
              <label className="full" htmlFor="star3" title="Um Bom Produto" />
              <input
                type="radio"
                className="rating"
                id="star2"
              ...
              <label
                className="full"
                htmlFor="star2"
                title="Cumpre o Prometido Nada a Mais"
              />
              <input
                type="radio"
                className="rating"
              ...
              <label
                className="full"
                htmlFor="star1"
                title="Não Recomendaria Isso Nem ao Meu Pior Inimigo"
              />
            </fieldset>
          </div>
          {/* Review Form */}
          <div className="space-y-4">
            <div className="flex flex-col">
              <label htmlFor="textArea">
                Sua Avaliação <span className="text-sm text-gray-600">*</span>
              </label>
              <textarea
                ...
                cols={30}
                rows={3}
                placeholder="Escreva sua Experiencia com o Produto..."
              />
            </div>
            <div
