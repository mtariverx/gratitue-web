  ...
  return (
    <Fragment>
      ...
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="text-2xl mx-2">Continuar</div>
        {/* Product List */}
                ...
                >
                  ...
                  <div className="flex flex-col py-2">
                    <label htmlFor="address" className="pb-2">
                      Informe o Email Que Recebera o Produto
                    </label>
                    <input
                      value={state.address}
                      onChange={(e) =>
                  ...
                  <div className="flex flex-col py-2 mb-2">
                    ...
                    Informe Seu Whatssap Para Confirmar o Pedido Antes do Envio
                    </label>
                    <input
                      value={state.phone}
                      onChange={(e) =>
                  ...
                  {  //Pagamento com cartões via Paypal
                  <DropIn
                    options={{
                  ...
                  {<div  //Botão de Pagamento via Paypal
                    onClick={(e) =>
                      pay(
                        data,
                        dispatch,
