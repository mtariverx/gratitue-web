...
export const pay = async (
  ...
  console.log(state);
  if (!state.address) {
    setState({ ...state, error: "Por Favor Informe o Email que Deseja Receber o Produto" });
  } else if (!state.phone) {
    setState({ ...state, error: "Por Favor Informe um Whatsapp Para Confirmarmos O Pedido " });
  } else {
    let nonce;
