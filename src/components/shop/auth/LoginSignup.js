...
const LoginSignup = (props) => {
  ...
  const [loginValue, setLoginValue] = useState("Criar Uma Conta");
  ...
  const changeLoginSignup = () => {
    if (login) {
      setLogin(false);
      setLoginValue("Ja Tenho Uma Conta");
      
    } else {
      setLogin(true);
      setLoginValue("Criar Uma Conta");
    }
    ...
    <Fragment>
      ...
      >
        <div className="w-11/12 md:w-3/5 lg:w-2/4 relative space-y-4 bg-white p-6 md:px-12 md:py-6">
          ...
          <center><b>Login Via Google e Facebook</b></center>
          <div
