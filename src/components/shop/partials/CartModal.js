        ...
        >
          <div className="overflow-y-auto">
            <div className="border-b border-gray-700 flex justify-between">
              <div className="p-4 text-white text-lg font-semibold">Sua Mochila</div>
                        ...
                        <div className="relative w-full flex flex-col">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div>
                              ...
                              R${subTotal(item._id, item.pPrice)},00
                            </div>{" "}
                            {/* SUbtotal Count */}
                          </div>
          ...
          <div className="m-4 space-y-4">
            <div
              onClick={(e) => cartModalOpen()}
              className="cursor-pointer px-4 bg-white py-2 border border-green-400 text-green text-center cursor-pointer"
            >
              Adicionar Mais Itens a Minha Mochila
            </div>
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  <div
                    className="cursor-pointer px-4 bg-black py-2 border border-green-4000 text-green text-center cursor-pointer"
                    onClick={(e) => {
                      history.push("/checkout");
                      cartModalOpen();
                    }}
                  >
                    Continuar R$ {data.cartTotalCost},00
                  </div>
                ) : (
                  <div
                  ...
                  >
                    Continuar ${data.cartTotalCost}.00
                  </div>
                )}
              </Fragment>
            ) : (
